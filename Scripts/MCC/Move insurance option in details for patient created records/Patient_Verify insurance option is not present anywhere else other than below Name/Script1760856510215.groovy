...
String xpathAfterDOB = "//p[contains(text(),'Date of Birth')]/following::p[contains(text(),'Insurance Product')]"

// Find elements
List<WebElement> insuranceAfterDOB = WebUI.findWebElements(
    new TestObject().addProperty("xpath", ConditionType.EQUALS, xpathAfterDOB),
    5
)
