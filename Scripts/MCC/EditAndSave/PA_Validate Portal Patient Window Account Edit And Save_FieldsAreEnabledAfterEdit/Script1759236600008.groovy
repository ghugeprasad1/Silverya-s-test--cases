...
try {
    def lastName = WebUI.callTestCase(findTestCase('MCC/FillPatientForm'), [:], FailureHandling.STOP_ON_FAILURE)
    ...
    WebUI.click(findTestObject('Page_MyCareCoverage - Patient Information/button_BackButtonInPatientForm'), FailureHandling.STOP_ON_FAILURE)
    ...
    WebUI.click(findTestObject('Page_MyCareCoverage - Household/button_Edit_EditPatientInHouseHoldPage'))

    WebUI.verifyElementPresent(findTestObject('Page_MyCareCoverage - Patient Information/header_EditPatientPageHeader'), 
        0)

    WebUI.verifyElementPresent(findTestObject('Page_MyCareCoverage - Patient Information/input_EmailFieldPatientIntakeForm_Enabled'), 
        0)
}
catch (Exception e) {
