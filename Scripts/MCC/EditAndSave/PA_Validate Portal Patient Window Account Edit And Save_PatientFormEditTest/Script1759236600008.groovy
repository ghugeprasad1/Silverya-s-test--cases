...
try {
    ...
    WebUI.setText(findTestObject('Page_MyCareCoverage/input_PatientForm_LastName'), 'ducky')
    ...
    WebUI.verifyElementPresent(findTestObject('Page_MyCareCoverage - Household/button_Back_PageBottomButton'), 5)

    WebUI.click(findTestObject('Page_MyCareCoverage - Household/button_Edit_AddHouseHold'))

    WebUI.verifyElementAttributeValue(
    findTestObject('Page_MyCareCoverage/input_PatientForm_FirstName'),
    'value',    // <-- this is the attribute to check
    'monkil',   // <-- the expected value
    0           // <-- timeout in seconds
    )
	WebUI.verifyElementAttributeValue(
		findTestObject('Page_MyCareCoverage/input_PatientForm_LastName'),
		'value',    // <-- this is the attribute to check
		'ducky',   // <-- the expected value
		0           // <-- timeout in seconds
		)
}
catch (Exception e) {
