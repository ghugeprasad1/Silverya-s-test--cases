...
try {
    ...
    WebUI.verifyElementPresent(findTestObject('Page_MyCareCoverage/text_DiscardChangesOverlayFullText'), 0)

    WebUI.verifyElementPresent(findTestObject('Page_MyCareCoverage/button_CancelbtnOnDiscardChangesOverlay'), 0)

    WebUI.verifyElementPresent(findTestObject('Page_MyCareCoverage/button_DiscardAndContinueButtonOnDiscardChangesOverlay'), 
        0)
    ...
    WebUI.verifyElementPresent(findTestObject('Page_MyCareCoverage/button_AddMember_AddHouseHoldPage'), 0)
}
catch (Exception e) {
