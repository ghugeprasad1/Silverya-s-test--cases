...
try {
    ...
    // Adjust for timezone difference (subtract 1 day)
    ...
    String webDate = WebUI.getAttribute(findTestObject('Page_MyCareCoverage/Input_AdmittanceDate'), 'value')

    // Verify the value matches expected adjusted date
    WebUI.verifyMatch(webDate, expectedDate, false)
}
catch (Exception e) {
