...
try {
    ...
    WebUI.click(findTestObject('Page_MyCareCoverage/checkbox_No_60DaysLostHealthInsurance_PatientForm'))

    WebUI.verifyElementNotPresent(findTestObject('Page_MyCareCoverage/input_Yes_EnterDate60DaysLostHealthInsurance_PatientForm'), 
        0)
}
catch (Exception e) {
