...
WebUI.setText(findTestObject('Page_MyCareCoverage/input_PatientForm_FirstName'), firstName)
//
//WebUI.setText(findTestObject('Page_MyCareCoverage/input_PatientForm_LastName'), 'Duplicate')
//
...
WebUI.sendKeys(findTestObject('Page_MyCareCoverage/input_PatientForm_DateOfBirth'), dob)
...
WebUI.sendKeys(findTestObject('Page_MyCareCoverage/input_SSN_PatientForm'), ssn)
...
WebUI.setText(findTestObject('Page_MyCareCoverage/input_ZipCode_PatientForm'), zip)
