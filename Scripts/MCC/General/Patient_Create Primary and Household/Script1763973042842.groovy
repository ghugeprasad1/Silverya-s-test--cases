...
// Generate unique last name for Primary
...
WebUI.sendKeys(findTestObject('Page_MyCareCoverage/input_PatientForm_DateOfBirth'), '02/02/1998')
...
WebUI.sendKeys(findTestObject('Page_MyCareCoverage/input_SSN_PatientForm'), '789-87-6587')
...
WebUI.setText(findTestObject('Page_MyCareCoverage/input_AddressLine1_PatientForm'), '87 West Minister Abbey')

WebUI.setText(findTestObject('Page_MyCareCoverage/input_PatientForm_City'), 'Bagdad')
...
WebUI.setText(findTestObject('Page_MyCareCoverage/input_ZipCode_PatientForm'), '40003')
...
WebUI.click(findTestObject('Page_MyCareCoverage - Household/button_AddHouseHoldMember_PatientIntakeEntry'))

WebUI.delay(5)

//WebUI.verifyElementPresent(findTestObject('Page_MyCareCoverage - Patient Information/header_PatientEntryPageHeader'), 3)
WebUI.setText(findTestObject('Page_MyCareCoverage/input_PatientForm_LastName'), 'Household')

WebUI.setText(findTestObject('Page_MyCareCoverage/input_PatientForm_FirstName'), 'Additional')

WebUI.click(findTestObject('Page_MyCareCoverage/input_PatientForm_DateOfBirth'))

WebUI.sendKeys(findTestObject('Page_MyCareCoverage/input_PatientForm_DateOfBirth'), '06/06/2018')
